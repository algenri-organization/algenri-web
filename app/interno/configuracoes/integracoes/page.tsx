import { BadgeCheck, Banknote, Cloud, Database, GitBranch, Mail, MessageCircle, PlugZap, ShieldCheck } from "lucide-react";
...
export default function IntegracoesPage() {
  ...
  const integrations: IntegrationCard[] = [
    {
      title: "Vercel",
      category: "Aplicação e deploy",
      status: "operational",
      statusLabel: "Operacional",
      detail: "Hospedagem e pipeline de deploy da aplicação ALGENRI.",
      icon: Cloud,
      items: ["Deploy integrado ao GitHub", "Ambientes de preview e produção", "Domínio da aplicação configurado"],
    },
    {
      title: "Firebase",
      ...
      status: "operational",
      statusLabel: "Operacional",
      detail: "Base da autenticação interna, Firestore e armazenamento de arquivos da plataforma.",
      icon: Database,
      items: ["Firebase Authentication", "Firestore", "Storage via backend autenticado"],
    },
    {
      title: "GitHub",
      category: "Código e governança",
      status: "operational",
      statusLabel: "Operacional",
      detail: "Repositório, branches, pull requests e validação contínua do projeto.",
      icon: GitBranch,
      items: ["Repositório principal conectado", "Fluxo por pull request", "CI antes de merge"],
    },
    {
      ...
      status: "operational",
      statusLabel: "Operacional",
      detail: "E-mail corporativo da ALGENRI validado para envio e recebimento.",
      icon: Mail,
      items: ["contato@algenri.com.br", "SPF, DKIM e DMARC validados", "Canal comercial ativo"],
    },
    {
      title: "WhatsApp / Meta",
      category: "Comunicação",
      status: "pending",
      statusLabel: "Automação pendente",
      detail: "O canal comercial está ativo; automações e templates continuam como evolução externa.",
      icon: MessageCircle,
      items: ["Canal público disponível", "Automação não considerada concluída", "Templates Meta permanecem fora do bloqueio operacional"],
    },
    {
      title: "C6 Bank",
      category: "Financeiro",
      status: "pending",
      statusLabel: "Aguardando banco",
      detail: c6?.detail ?? "Integração solicitada; API, homologação e credenciais ainda precisam ser confirmadas pelo banco.",
      icon: Banknote,
      items: ["Controle financeiro permanece manual", "Nenhuma credencial C6 é presumida", "Integração real só após retorno oficial"],
    },
    {
      title: "Cora",
      category: "Financeiro",
      status: "deferred",
      statusLabel: "Adiada",
      detail: cora?.detail ?? "Alternativa futura, sem ativação nesta fase.",
      icon: Banknote,
      items: ["Sem custo adicional nesta fase", "Não participa do fluxo atual", "Pode ser retomada futuramente"],
    },
  ];
