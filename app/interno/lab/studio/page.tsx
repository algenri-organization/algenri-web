...
const foundation = [
  ...
  { title: "Biblioteca de Vozes", detail: "Perfis reutilizáveis de narração, interpretação e pronúncia sem gerar áudio automaticamente.", href: "/interno/lab/studio/vozes", icon: Mic2 },
  ...
  return <main className="min-h-screen bg-[#040c17] px-6 pb-20 pt-28 text-white">
    <div className="mx-auto max-w-6xl">
      ...
      <section className="mt-7">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-3">{foundation.map(({title,detail,href,icon:Icon}) => {
