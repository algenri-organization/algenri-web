...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/psico-algenri`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${baseUrl}/psico-algenri/privacidade`, lastModified: now, changeFrequency: "yearly", priority: 0.5 },
    { url: `${baseUrl}/psico-algenri/termos`, lastModified: now, changeFrequency: "yearly", priority: 0.4 },
    { url: `${baseUrl}/psico-algenri/excluir-conta`, lastModified: now, changeFrequency: "yearly", priority: 0.5 },
