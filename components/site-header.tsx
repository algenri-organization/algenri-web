      ...
      <div className="mx-auto flex h-[76px] max-w-7xl items-center justify-between px-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-7 text-sm text-white/64 md:flex" aria-label="Navegação principal">
          ...
          <div className="group relative">
            ...
            <div className="invisible absolute left-1/2 top-[66px] w-[390px] -translate-x-1/2 translate-y-2 rounded-[26px] border border-white/10 bg-[#071522]/98 p-3 opacity-0 shadow-[0_24px_80px_rgba(0,0,0,.45)] backdrop-blur-2xl transition duration-200 group-hover:visible group-hover:translate-y-0 group-hover:opacity-100 group-focus-within:visible group-focus-within:translate-y-0 group-focus-within:opacity-100">
