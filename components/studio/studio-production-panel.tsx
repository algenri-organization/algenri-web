...
import { CheckCircle2, Coins, Loader2, Play, RefreshCw, ShieldCheck, TriangleAlert } from "lucide-react";
...
type SceneJob = { sceneIndex:number; provider:string; model:string|null; taskId:string; status:"queued"|"running"|"succeeded"|"failed"; estimatedCredits:number|null; actualCredits:number|null; outputUrl:string|null; failure?:unknown|null };
