...
export async function startStudioSandboxRender(projectId:string):Promise<StudioFinalRenderManifest>{
  ...
  const outputStoragePath=`studio/projects/${projectId}/final/ALGENRI-Studio-Final.mp4`;const statusStoragePath=`studio/projects/${projectId}/final/render-status.txt`;
