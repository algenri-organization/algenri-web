...
export const studioProviders: StudioProvider[] = [
  {
    ...
    phase: 2,
    status: "priority",
    capabilities: ["video", "image", "editing", "voice", "audio"],
  ...
  },
  {
    ...
    role: "Motor premium para vídeo generativo com foco em qualidade visual, direção cinematográfica e cenas complexas.",
    integrationMode: "api",
    costControl: "Reservar para cenas em que o ganho de qualidade justificar custo superior ou maior latência.",
    selectable: true,
  },
  {
    id: "luma",
    ...
    role: "Alternativa para geração visual e image-to-video, útil no roteamento automático por custo e estilo.",
    integrationMode: "api",
    costControl: "Comparar custo por segundo e taxa de aprovação de cena antes de promover no roteamento automático.",
    selectable: true,
  },
  {
    id: "seedance",
    ...
    status: "planned",
    capabilities: ["video", "image"],
    role: "Motor adicional para cenas generativas e consistência, sujeito a benchmark de disponibilidade e integração.",
    integrationMode: "api",
    costControl: "Entrar primeiro por testes equivalentes de cena e somente depois receber peso no modo automático.",
    selectable: true,
  },
  {
    id: "kling",
    ...
    status: "planned",
    capabilities: ["video", "image"],
    role: "Motor alternativo para geração de vídeo e image-to-video, com potencial para cenas realistas e movimentos complexos.",
    integrationMode: "api",
    costControl: "Usar benchmark por duração, aderência e consistência antes de selecionar automaticamente.",
    selectable: true,
  },
  {
    id: "heygen",
    ...
    phase: 2,
    status: "priority",
    capabilities: ["video", "avatar", "voice", "lip-sync", "audio"],
  ...
  {
    id: "grok-kie",
    name: "Grok via Kie.ai",
    layer: "gateway",
    phase: 3,
    status: "planned",
    capabilities: ["video", "image", "multimodel"],
    role: "Acesso a modelos disponibilizados via Kie.ai, tratado como opção de motor quando houver suporte e vantagem operacional.",
    integrationMode: "api",
    costControl: "Comparar preço, disponibilidade e limites do gateway antes de usar em produção.",
    selectable: true,
  },
  {
    id: "kie-ai",
